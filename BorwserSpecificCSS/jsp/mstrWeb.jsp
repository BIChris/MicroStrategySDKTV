...
//this function call will get the browser version and type. with this info it will apply custom style sheets
add();
...
function add() {
    ...
    if (sBrowserName.toUpperCase() === 'CHROME') {
  	
        tmp.setAttribute("href", "../plugins/BorwserSpecificCSS/style/chrome.css");
    }
    if (sBrowserName.toUpperCase() === 'FIREFOX') {
        tmp.setAttribute("href", "../plugins/BorwserSpecificCSS/style/firefox.css");
    }
    if (sBrowserName.toUpperCase() === 'MSIE') {
        if (sBrowserVersionMajor === '7') {
            tmp.setAttribute("href", "../plugins/BorwserSpecificCSS/style/ie7.css");

        }
        if (sBrowserVersionMajor === '8') {
            tmp.setAttribute("href", "../plugins/BorwserSpecificCSS/style/ie8.css");
        }
        if (sBrowserVersionMajor === '9') {
            tmp.setAttribute("href", "../plugins/BorwserSpecificCSS/style/ie9.css");
        }
        if (sBrowserVersionMajor === '10') {
            tmp.setAttribute("href", "../plugins/BorwserSpecificCSS/style/ie10.css");
        }
    }
